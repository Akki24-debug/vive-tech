...
import { BrainControlPanel } from "./features/brain-control/BrainControlPanel";
...
const defaultConfig: RuntimeConfigInput = {
  ...
  optimization: {
    ...
    debugModelOverride: "gpt-5-mini",
    disableBroadBrainSnapshots: true,
    skipFinalLlmForSimpleReads: true,
    logEstimatedCost: true,
    maxRecentConversationMessages: 4,
    maxDocs: 4,
    maxDocsBundleBytes: 24000
  }
};
...
function buildPayload(
  ...
  return {
    ...
    optimization: {
      ...form.optimization,
      debugModelOverride: form.optimization?.debugModelOverride || undefined
    }
  };
}
