...
## Scope
This guide maps where to look in `bd`, and documents how each SP behaves at IO level.

- Folder with SQL runtime assets: `Core de Operaciones/bd`
...
- Keep migration/fix/import scripts outside `bd` (example: `Core de Operaciones/PMS/migrations`).
