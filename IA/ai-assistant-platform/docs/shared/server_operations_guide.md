...
- Repo available locally at:
  - `C:\Users\ragnarok\Documents\repos\Proyecto VLV\IA\ai-assistant-platform`
...
```powershell
cd "C:\Users\ragnarok\Documents\repos\Proyecto VLV\BusinessBrainDB\scripts"
...
```powershell
cd "C:\Users\ragnarok\Documents\repos\Proyecto VLV\IA\ai-assistant-platform"
npm install
```
