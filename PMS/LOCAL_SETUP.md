...
- [config.local.example.php](/Users/ragnarok/Documents/repos/vive-tech-pms/public_html/pms%20db%20connections/config.local.example.php)
- [activate-local-db-tools.ps1](/Users/ragnarok/Documents/repos/vive-tech-pms/scripts/activate-local-db-tools.ps1)
- [create-local-db.ps1](/Users/ragnarok/Documents/repos/vive-tech-pms/scripts/create-local-db.ps1)
- [import-local-dump.ps1](/Users/ragnarok/Documents/repos/vive-tech-pms/scripts/import-local-dump.ps1)
- [start-local-pms.ps1](/Users/ragnarok/Documents/repos/vive-tech-pms/scripts/start-local-pms.ps1)
- [check-local-prereqs.ps1](/Users/ragnarok/Documents/repos/vive-tech-pms/scripts/check-local-prereqs.ps1)
...
```powershell
cd "C:\Users\ragnarok\Documents\repos\vive-tech-pms"
...
```powershell
.\scripts\import-local-dump.ps1 -DumpPath .\local-dumps\tu_dump.sql -Database vlv_pms_local -User root
```
...
```powershell
cd "C:\Users\ragnarok\Documents\repos\vive-tech-pms"
.\scripts\check-local-prereqs.ps1
```
...
Esa carpeta ya existe y esta ignorada por Git.
