...
<script>
  (function () {
    ...
    var collectVisibleReportRows = function () {
      ...
      var allRows = [];
      wrap.querySelectorAll('table[data-result-scope]').forEach(function (table) {
    ...
    if (exportExcelButton) {
      exportExcelButton.addEventListener('click', exportVisibleReportToExcel);
    }
    if (exportGoogleButton) {
      exportGoogleButton.addEventListener('click', exportVisibleReportToCsv);
    }
