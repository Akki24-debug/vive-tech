      ...
      <div class="report-v2-grid-toolbar">
        ...
        <div class="report-v2-grid-toolbar-actions">
          <?php if ($runTemplate && !empty($reportRows)): ?>
            <?php
              $exportRunStateContext = array(
                  'selectedTemplateId' => $selectedTemplateId,
                  'selectedCalculationId' => $selectedCalculationId,
                  'runFilters' => $runFilters,
                  'reportGridSubdivideFieldId' => $reportGridSubdivideFieldId,
                  'reportGridSubdivideFieldIdLevel2' => $reportGridSubdivideFieldIdLevel2,
                  'reportGridSubdivideFieldIdLevel3' => $reportGridSubdivideFieldIdLevel3,
                  'reportGridSubdivideSortLevel1' => $reportGridSubdivideSortLevel1,
                  'reportGridSubdivideSortLevel2' => $reportGridSubdivideSortLevel2,
                  'reportGridSubdivideShowTotalsLevel1' => $reportGridSubdivideShowTotalsLevel1,
                  'reportGridSubdivideShowTotalsLevel2' => $reportGridSubdivideShowTotalsLevel2,
              );
            ?>
            <button type="button" class="report-v2-export-button" id="report-v2-export-excel">Excel</button>
            <button type="button" class="report-v2-export-button" id="report-v2-export-google">Google Sheets/Drive (CSV)</button>
          <?php endif; ?>
