...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateActionBar() {
    ...
    if (isMobileCalendar()) {
      ...
      const anyVisible = [blockButton, createButton, quickResButton, viewResButton, moveResButton, duplicateResButton, payResButton, addChargesButton, advanceStatusButton, noShowButton, cancelResButton, groupResButton, deleteBlocksButton]
        .some(function (btn) { return !!btn && !btn.hidden; });
      actionBar.classList.toggle('is-visible', anyVisible);
    } else {
      [blockButton, createButton, quickResButton, viewResButton, moveResButton, duplicateResButton, payResButton, addChargesButton, advanceStatusButton, noShowButton, cancelResButton, groupResButton, deleteBlocksButton].forEach(function (btn) {
        if (!btn) return;
