...
$runFilters = array(
    ...
    // La busqueda base quedo obsoleta; solo deben afectar los filtros visibles.
    'search' => '',
);
  ...
  (function () {
    ...
    var updateReservationRowsFromPayload = function (reservationId, payloadCells) {
      ...
      rows.forEach(function (row) {
        Object.keys(payloadCells || {}).forEach(function (fieldId) {
          ...
          if (displayNode) {
            displayNode.textContent = String(payload.display || '');
          } else {
            cell.textContent = String(payload.display || '');
          }
    ...
    if (clearGridFiltersButton) {
      clearGridFiltersButton.addEventListener('click', function () {
        if (gridRuntimeSubdivideFieldId > 0 || gridRuntimeSubdivideFieldIdLevel2 > 0 || gridRuntimeSubdivideFieldIdLevel3 > 0 || gridRuntimeSubdivideShowTotalsLevel1 !== null || gridRuntimeSubdivideShowTotalsLevel2 !== null) {
          var baseUrl = buildBaseReportUrl();
