      ...
      <?php else: ?>
        <div class="report-v2-table-wrap">
          <table class="report-v2-table">
            <thead><tr><th>Orden</th><th>Campo</th><th>Tipo</th><th>Origen</th><th>Default</th><th>Formato</th><th>Visible</th><th>Activa</th><th></th><th></th></tr></thead>
            <tbody>
              <?php if (empty($templateFields)): ?>
                <tr><td colspan="10" class="report-v2-muted">La plantilla no tiene campos.</td></tr>
              <?php else: ?>
