...
if (isset($_SERVER['REQUEST_METHOD']) && $_SERVER['REQUEST_METHOD'] === 'POST') {
    $reportsIncomingBuilderAction = isset($_POST['builder_action']) ? trim((string)$_POST['builder_action']) : '';
    $reportsIncomingAccountingSave = isset($_POST['accounting_save_config']) && (string)$_POST['accounting_save_config'] === '1';
    if ($activeTab === 'builder' && $reportsIncomingBuilderAction !== '') {
        pms_require_permission('reports.design');
    } elseif ($activeTab === 'accounting' && $reportsIncomingAccountingSave) {
        pms_require_permission('reports.design');
    } else {
        pms_require_permission('reports.run');
    }
}
