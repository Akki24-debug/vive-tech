...
-- Tiempo de generación: 25-02-2026 a las 22:58:21
...
--
-- Base de datos: `u508158532_rodbd`
--
...
--
-- Estructura de tabla para la tabla `activity_booking`
--
...
--
-- Estructura de tabla para la tabla `activity_booking_reservation`
--
...
--
-- Estructura de tabla para la tabla `category_amenities`
--
...
--
-- Estructura de tabla para la tabla `category_bed_config`
--
...
--
-- Estructura de tabla para la tabla `category_calendar_amenity_display`
--
...
--
-- Estructura de tabla para la tabla `line_item`
--
...
--
-- Estructura de tabla para la tabla `line_item_catalog`
--
...
--
-- Estructura de tabla para la tabla `line_item_catalog_calc`
--
...
--
-- Estructura de tabla para la tabla `line_item_catalog_parent`
--
...
--
-- Estructura de tabla para la tabla `line_item_hierarchy`
--
...
--
-- Estructura de tabla para la tabla `message_template`
--
...
--
-- Estructura de tabla para la tabla `obligation_payment_log`
--
...
--
-- Estructura de tabla para la tabla `ota_account`
--
...
--
-- Estructura de tabla para la tabla `ota_account_info_catalog`
--
...
--
-- Estructura de tabla para la tabla `ota_account_lodging_catalog`
--
...
--
-- Estructura de tabla para la tabla `ota_ical_event`
--
...
--
-- Estructura de tabla para la tabla `ota_ical_event_map`
--
...
--
-- Estructura de tabla para la tabla `ota_ical_feed`
--
...
--
-- Estructura de tabla para la tabla `pms_company_theme`
--
...
--
-- Estructura de tabla para la tabla `pms_settings`
--
...
--
-- Estructura de tabla para la tabla `pms_settings_interest_catalog`
--
...
--
-- Estructura de tabla para la tabla `pms_settings_lodging_catalog`
--
...
--
-- Estructura de tabla para la tabla `pms_settings_obligation_payment_method`
--
...
--
-- Estructura de tabla para la tabla `pms_settings_payment_catalog`
--
...
--
-- Estructura de tabla para la tabla `pms_settings_payment_method`
--
...
--
-- Estructura de tabla para la tabla `property_amenities`
--
...
--
-- Estructura de tabla para la tabla `rateplan`
--
...
--
-- Estructura de tabla para la tabla `rateplan_override`
--
...
--
-- Estructura de tabla para la tabla `rateplan_pricing`
--
...
--
-- Estructura de tabla para la tabla `rateplan_season`
--
...
--
-- Estructura de tabla para la tabla `report_config`
--
...
--
-- Estructura de tabla para la tabla `report_config_column`
--
...
--
-- Estructura de tabla para la tabla `report_config_filter`
--
...
--
-- Estructura de tabla para la tabla `report_config_item_legacy`
--
...
--
-- Estructura de tabla para la tabla `report_field_catalog`
--
...
--
-- Estructura de tabla para la tabla `reservation_group`
--
...
--
-- Estructura de tabla para la tabla `reservation_group_member`
--
...
--
-- Estructura de tabla para la tabla `reservation_interest`
--
...
--
-- Estructura de tabla para la tabla `reservation_message_log`
--
...
--
-- Estructura de tabla para la tabla `reservation_note`
--
...
--
-- Estructura de tabla para la tabla `reservation_source_catalog`
--
...
--
-- Estructura de tabla para la tabla `roomcategory`
--
...
--
-- Estructura de tabla para la tabla `room_block`
--
...
--
-- Estructura de tabla para la tabla `sale_item_category`
--
...
--
-- Indices de la tabla `activity_booking`
--
...
--
-- Indices de la tabla `activity_booking_reservation`
--
...
--
-- Indices de la tabla `category_amenities`
--
...
--
-- Indices de la tabla `category_bed_config`
--
...
--
-- Indices de la tabla `category_calendar_amenity_display`
--
...
--
-- Indices de la tabla `line_item_catalog`
--
...
--
-- Indices de la tabla `line_item_catalog_calc`
--
...
--
-- Indices de la tabla `line_item_catalog_parent`
--
...
--
-- Indices de la tabla `line_item_hierarchy`
--
...
--
-- Indices de la tabla `message_template`
--
...
--
-- Indices de la tabla `obligation_payment_log`
--
...
--
-- Indices de la tabla `ota_account`
--
...
--
-- Indices de la tabla `ota_account_info_catalog`
--
...
--
-- Indices de la tabla `ota_account_lodging_catalog`
--
...
--
-- Indices de la tabla `ota_ical_event`
--
...
--
-- Indices de la tabla `ota_ical_event_map`
--
...
--
-- Indices de la tabla `ota_ical_feed`
--
...
--
-- Indices de la tabla `pms_company_theme`
--
ALTER TABLE `pms_company_theme`
  ADD PRIMARY KEY (`id_company`);

--
-- Indices de la tabla `pms_settings`
--
...
--
-- Indices de la tabla `pms_settings_interest_catalog`
--
...
--
-- Indices de la tabla `pms_settings_lodging_catalog`
--
...
--
-- Indices de la tabla `pms_settings_obligation_payment_method`
--
...
--
-- Indices de la tabla `pms_settings_payment_catalog`
--
...
--
-- Indices de la tabla `pms_settings_payment_method`
--
...
--
-- Indices de la tabla `property_amenities`
--
...
--
-- Indices de la tabla `rateplan_override`
--
...
--
-- Indices de la tabla `rateplan_pricing`
--
...
--
-- Indices de la tabla `rateplan_season`
--
...
--
-- Indices de la tabla `report_config`
--
...
--
-- Indices de la tabla `report_config_column`
--
...
--
-- Indices de la tabla `report_config_filter`
--
...
--
-- Indices de la tabla `report_config_item_legacy`
--
...
--
-- Indices de la tabla `report_field_catalog`
--
...
--
-- Indices de la tabla `reservation_group`
--
...
--
-- Indices de la tabla `reservation_group_member`
--
...
--
-- Indices de la tabla `reservation_interest`
--
...
--
-- Indices de la tabla `reservation_message_log`
--
...
--
-- Indices de la tabla `reservation_note`
--
...
--
-- Indices de la tabla `reservation_source_catalog`
--
...
--
-- Indices de la tabla `roomcategory`
--
...
--
-- Indices de la tabla `room_block`
--
...
--
-- Indices de la tabla `sale_item_category`
--
...
--
-- AUTO_INCREMENT de la tabla `activity_booking`
--
ALTER TABLE `activity_booking`
...
--
-- AUTO_INCREMENT de la tabla `category_amenities`
--
ALTER TABLE `category_amenities`
  MODIFY `id_category_amenities` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `category_bed_config`
--
ALTER TABLE `category_bed_config`
  MODIFY `id_bed_config` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `category_calendar_amenity_display`
--
ALTER TABLE `category_calendar_amenity_display`
...
--
-- AUTO_INCREMENT de la tabla `pms_settings`
--
ALTER TABLE `pms_settings`
  MODIFY `id_setting` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pms_settings_interest_catalog`
--
ALTER TABLE `pms_settings_interest_catalog`
  MODIFY `id_setting_interest` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pms_settings_lodging_catalog`
--
ALTER TABLE `pms_settings_lodging_catalog`
  MODIFY `id_setting_lodging` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pms_settings_obligation_payment_method`
--
ALTER TABLE `pms_settings_obligation_payment_method`
  MODIFY `id_obligation_payment_method` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pms_settings_payment_catalog`
--
ALTER TABLE `pms_settings_payment_catalog`
  MODIFY `id_setting_payment` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `pms_settings_payment_method`
--
ALTER TABLE `pms_settings_payment_method`
...
--
-- AUTO_INCREMENT de la tabla `roomcategory`
--
ALTER TABLE `roomcategory`
  MODIFY `id_category` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `room_block`
--
ALTER TABLE `room_block`
  MODIFY `id_room_block` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `sale_item_category`
--
ALTER TABLE `sale_item_category`
...
--
-- Filtros para la tabla `activity_booking`
--
ALTER TABLE `activity_booking`
...
--
-- Filtros para la tabla `activity_booking_reservation`
--
ALTER TABLE `activity_booking_reservation`
...
--
-- Filtros para la tabla `category_amenities`
--
ALTER TABLE `category_amenities`
...
--
-- Filtros para la tabla `category_bed_config`
--
ALTER TABLE `category_bed_config`
...
--
-- Filtros para la tabla `category_calendar_amenity_display`
--
ALTER TABLE `category_calendar_amenity_display`
...
--
-- Filtros para la tabla `message_template`
--
ALTER TABLE `message_template`
...
--
-- Filtros para la tabla `ota_ical_event`
--
ALTER TABLE `ota_ical_event`
...
--
-- Filtros para la tabla `ota_ical_event_map`
--
ALTER TABLE `ota_ical_event_map`
...
--
-- Filtros para la tabla `ota_ical_feed`
--
ALTER TABLE `ota_ical_feed`
...
--
-- Filtros para la tabla `pms_company_theme`
--
ALTER TABLE `pms_company_theme`
...
--
-- Filtros para la tabla `property_amenities`
--
ALTER TABLE `property_amenities`
...
--
-- Filtros para la tabla `rateplan`
--
ALTER TABLE `rateplan`
...
--
-- Filtros para la tabla `rateplan_override`
--
ALTER TABLE `rateplan_override`
...
--
-- Filtros para la tabla `report_config_column`
--
ALTER TABLE `report_config_column`
...
--
-- Filtros para la tabla `report_config_filter`
--
ALTER TABLE `report_config_filter`
...
--
-- Filtros para la tabla `report_config_item_legacy`
--
ALTER TABLE `report_config_item_legacy`
...
--
-- Filtros para la tabla `reservation_group`
--
ALTER TABLE `reservation_group`
...
--
-- Filtros para la tabla `reservation_group_member`
--
ALTER TABLE `reservation_group_member`
...
--
-- Filtros para la tabla `reservation_interest`
--
ALTER TABLE `reservation_interest`
...
--
-- Filtros para la tabla `reservation_message_log`
--
ALTER TABLE `reservation_message_log`
...
--
-- Filtros para la tabla `reservation_note`
--
ALTER TABLE `reservation_note`
...
--
-- Filtros para la tabla `reservation_source_catalog`
--
ALTER TABLE `reservation_source_catalog`
...
--
-- Filtros para la tabla `roomcategory`
--
ALTER TABLE `roomcategory`
...
--
-- Filtros para la tabla `room_block`
--
ALTER TABLE `room_block`
...
--
-- Filtros para la tabla `sale_item_category`
--
ALTER TABLE `sale_item_category`
