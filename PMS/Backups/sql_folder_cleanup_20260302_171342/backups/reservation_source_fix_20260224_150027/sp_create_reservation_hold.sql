...
proc:BEGIN
  ...
  SELECT id_property, id_company, currency
    INTO v_id_property, v_id_company, v_currency
  FROM property
  ...
  IF v_use_rateplan = 1 AND v_rate_breakdown IS NOT NULL AND v_rate_breakdown <> '' THEN
