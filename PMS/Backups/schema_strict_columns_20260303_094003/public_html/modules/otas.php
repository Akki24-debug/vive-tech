...
if (!function_exists('ota_info_catalog_has_display_alias_column')) {
    function ota_info_catalog_has_display_alias_column()
    {
        static $cached = null;
        if ($cached !== null) {
            return $cached;
        ...
        try {
            ...
            $cached = $stmt && $stmt->fetch() ? true : false;
        } catch (Exception $e) {
            $cached = false;
        }
        return $cached;
...
$otaInfoHasAliasColumn = ota_info_catalog_has_display_alias_column();
