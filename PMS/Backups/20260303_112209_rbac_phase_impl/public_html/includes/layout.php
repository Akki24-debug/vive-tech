    ...
    <nav class="sidebar-nav">
      <div class="sidebar-section">
        ...
        <div class="sidebar-links">
          ...
          <a href="index.php?view=calendar">Calendario</a>
          <a href="index.php?view=properties">Propiedades</a>
          <a href="index.php?view=users">Usuarios</a>
          <a href="index.php?view=activities">Actividades</a>
          <a href="index.php?view=rooms">Habitaciones</a>
          <a href="index.php?view=categories">Categorias</a>
          <a href="index.php?view=rateplans">Tarifas</a>
          <a href="index.php?view=messages">Mensajes</a>
          <a href="index.php?view=guests">Huespedes</a>
          <a href="index.php?view=reservations">Reservas</a>
          <a href="index.php?view=payments">Pagos</a>
          <a href="index.php?view=incomes">Ingresos</a>
          <a href="index.php?view=otas">OTAs</a>
          <a href="index.php?view=ota_ical">iCal OTAs</a>
          <a href="index.php?view=settings">Configuraciones</a>
        </div>
      </div>
      <div class="sidebar-section">
        <button class="sidebar-section-toggle" type="button">
        ...
        <div class="sidebar-links">
          <a href="index.php?view=sale_items">Conceptos</a>
          <a href="index.php?view=payments">Pagos</a>
          <a href="index.php?view=incomes">Ingresos</a>
          <a href="index.php?view=obligations">Obligaciones</a>
          <a href="index.php?view=reports">Reportes</a>
        </div>
      </div>
    </nav>
  </aside>
