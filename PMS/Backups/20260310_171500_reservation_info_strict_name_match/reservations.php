...
foreach ($openReservationIds as $reservationId) {
    ...
    if ($reservationInfoConfigRows) {
        ...
        foreach ($reservationInfoConfigRows as $cfg) {
            ...
            foreach (array($label, $defaultLabel, $itemName) as $sourceLabelCandidate) {
        ...
        foreach ($otaInfoSourceRows as $otaInfoRow) {
            ...
            $otaInfoSourceDescription = isset($otaInfoRow['description']) ? trim((string)$otaInfoRow['description']) : '';
            ...
            $otaInfoSourceDescriptionLabel = $otaInfoSourceCategory !== '' && $otaInfoSourceDescription !== ''
                ? ($otaInfoSourceCategory . ' / ' . $otaInfoSourceDescription)
                : $otaInfoSourceDescription;
            $otaInfoMatchedIdx = null;
            foreach (array($otaInfoSourceDefaultLabel, $otaInfoSourceItemName, $otaInfoSourceDescriptionLabel, $otaInfoSourceDescription) as $otaInfoSourceLabelCandidate) {
