...
<?php if ($categories): ?>
  ...
  <?php foreach ($propertyOrder as $propCode): ?>
    ...
    ?>
    <section class="category-property-section">
      <div class="category-property-head">
        <div>
          <h3 class="property-group-title"><?php echo htmlspecialchars($propertyName . ' (' . $propCode . ')', ENT_QUOTES, 'UTF-8'); ?></h3>
          <p class="muted">Checkout <?php echo htmlspecialchars($propertyCheckOutLabel, ENT_QUOTES, 'UTF-8'); ?> | <?php echo htmlspecialchars($propertyAddress, ENT_QUOTES, 'UTF-8'); ?></p>
        </div>
      ...
      <div class="category-card-grid">
        <?php foreach ($categoriesGrouped[$propCode]['rows'] as $cat): ?>
          ...
          ?>
          <article class="category-card<?php echo $isOpen ? ' is-open' : ''; ?>">
            ...
            <div class="category-property-meta">
              <span><strong>Propiedad:</strong> <?php echo htmlspecialchars($propertyName . ' / ' . $propCode, ENT_QUOTES, 'UTF-8'); ?></span>
...
.category-property-meta {
  border: 1px solid rgba(132, 182, 228, 0.2);
  border-radius: 10px;
  padding: 8px 10px;
  display: grid;
  gap: 5px;
