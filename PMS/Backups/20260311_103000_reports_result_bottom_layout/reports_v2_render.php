...
$runFilters = array(
    ...
    'status' => isset($_REQUEST['report_status']) ? trim((string)$_REQUEST['report_status']) : '',
        ...
        if ($action === 'save_field') {
            ...
            if ($fieldType === 'reservation') {
                ...
                foreach ($lineItemCatalogs as $catalogRow) {
                    if ((int)$catalogRow['id_line_item_catalog'] === $lineItemCatalogId) {
                        $selectedCatalog = $catalogRow;
                        break;
                    }
                }
                if (!$selectedCatalog) {
                ...
                if ($displayName === '') {
                    $displayName = trim((string)$selectedCatalog['item_name']) . ' / ' . $metricOptions[$sourceMetric]['label'];
                }
            ...
            if ($fieldId > 0) {
                ...
                $stmt->execute(array($fieldType, $displayName, $reservationFieldCode !== null && $reservationFieldCode !== '' ? $reservationFieldCode : null, $lineItemCatalogId > 0 ? $lineItemCatalogId : null, $reportCalculationId > 0 ? $reportCalculationId : null, $sourceMetric !== null && $sourceMetric !== '' ? $sourceMetric : null, $formatHint, $orderIndex, $isVisible, $isActive, $fieldId, $templateId));
                ...
                $stmt->execute(array($templateId, $fieldType, $displayName, $reservationFieldCode !== null && $reservationFieldCode !== '' ? $reservationFieldCode : null, $lineItemCatalogId > 0 ? $lineItemCatalogId : null, $reportCalculationId > 0 ? $reportCalculationId : null, $sourceMetric !== null && $sourceMetric !== '' ? $sourceMetric : null, $formatHint, $orderIndex, $isVisible, $isActive, $actorUserId > 0 ? $actorUserId : null));
