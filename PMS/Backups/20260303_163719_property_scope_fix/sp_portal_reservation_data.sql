...
BEGIN
  ...
  LEFT JOIN (
    ...
    WHERE cf.id_reservation = p_reservation_id
  ...
  LEFT JOIN (
    ...
    WHERE sf.id_reservation = p_reservation_id
  ...
  WHERE abr_link.id_reservation = p_reservation_id
  ...
  WHERE ri.id_reservation = p_reservation_id
