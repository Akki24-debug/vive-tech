...
| `sp_portal_guest_data.sql` | Read/query data | p_company_code, p_search, p_only_active, p_guest_id | - | - | Result set via SELECT; errors via SIGNAL 45000 |
...
| `sp_portal_reservation_data.sql` | Read/query data | p_company_code, p_property_code, p_status, p_from, p_to, p_reservation_id | - | - | Result set via SELECT; errors via SIGNAL 45000 |
