...
function mhub_hidden($activeTab, $propertyCode, $search, $reservationId)
{
              ...
              <tbody>
                <?php foreach ($dashboardRows as $row): ?>
                  ...
                  <tr class="<?php echo $selectedReservationId === $rowId ? 'is-selected' : ''; ?>">
                    ...
                    <td><?php echo htmlspecialchars(mhub_guest_name($row) !== '' ? mhub_guest_name($row) : 'Sin huesped', ENT_QUOTES, 'UTF-8'); ?><div class="muted"><?php echo htmlspecialchars((string)$row['guest_phone'], ENT_QUOTES, 'UTF-8'); ?></div></td>
                    ...
                    <td><form method="post"><?php mhub_hidden('messages-tab-dashboard', $selectedPropertyCode, $searchTerm, $rowId); ?><button type="submit" class="button-secondary">Abrir</button></form></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
                ...
                <article class="message-template-card <?php echo htmlspecialchars($cardClass, ENT_QUOTES, 'UTF-8'); ?>">
                  ...
                  <?php if ($canSendMessages): ?>
                    <form method="post" class="message-template-actions">
                      <?php mhub_hidden('messages-tab-dashboard', $selectedPropertyCode, $searchTerm, $selectedReservationId); ?>
      ...
      <section class="card">
        ...
        <div class="message-template-editor-layout">
          <form method="post" class="form-grid grid-2 message-template-form">
            <?php mhub_hidden('messages-tab-templates', $selectedPropertyCode, $searchTerm, $selectedReservationId); ?>
