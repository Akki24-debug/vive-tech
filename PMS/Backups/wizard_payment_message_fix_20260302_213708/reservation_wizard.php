  ...
  function initWizard() {
    ...
    function syncPaymentUi() {
      ...
      if (paymentPreview) {
        if (isFixed) {
          ...
          paymentPreview.textContent = 'Se registrara un pago completo por el saldo final del folio. Monto estimado: $' + formatMoney(amount) + ' MXN.';
        }
      }
    ...
    form.addEventListener('submit', function (event) {
      ...
      if (mode === 'fixed') {
        ...
        amount = getCurrentEstimatedGrandTotal();
        if (!(amount > 0)) {
          event.preventDefault();
          window.alert('No hay saldo estimado para aplicar pago completo.');
          return;
        }
      }
      ...
      var message = mode === 'fixed'
        ...
        : ('Se creara un pago completo por el saldo final del folio.\\nMonto estimado: $' + formatMoney(amount) + ' MXN.\\n\\n¿Deseas continuar?');
