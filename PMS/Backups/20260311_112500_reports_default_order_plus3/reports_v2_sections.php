      ...
      <?php else: ?>
        <div class="report-v2-table-wrap">
          <table class="report-v2-table">
            <thead><tr><th>Orden</th><th>Campo</th><th>Tipo</th><th>Origen</th><th>Formato</th><th>Visible</th><th>Activa</th><th></th><th></th></tr></thead>
            <tbody>
              <?php if (empty($templateFields)): ?>
                <tr><td colspan="9" class="report-v2-muted">La plantilla no tiene campos.</td></tr>
              <?php else: ?>
        ...
        <div class="report-v2-card report-v2-stack">
          ...
          <form method="post" class="report-v2-stack">
            ...
            <div class="report-v2-form-grid report-v2-form-grid--4">
              <label><span>Tipo</span><select name="field_type" id="reports-v2-field-type"><?php $selectedFieldType = $selectedField ? (string)$selectedField['field_type'] : 'reservation'; foreach (reports_v2_field_type_options() as $typeCode => $typeLabel): ?><option value="<?php echo reports_v2_h($typeCode); ?>" <?php echo $selectedFieldType === $typeCode ? 'selected' : ''; ?>><?php echo reports_v2_h($typeLabel); ?></option><?php endforeach; ?></select></label>
              <label><span>Orden</span><input type="number" name="order_index" min="1" value="<?php echo $selectedField ? (int)$selectedField['order_index'] : max(1, count($templateFields) + 1); ?>"></label>
            ...
            <div class="report-v2-form-grid">
              <label><span>Nombre visible</span><input type="text" name="display_name" value="<?php echo reports_v2_h($selectedField ? $selectedField['display_name'] : ''); ?>" placeholder="Opcional; si lo dejas vacio toma el nombre base"></label>
