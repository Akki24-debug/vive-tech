...
<body class="<?php echo htmlspecialchars($themeClass, ENT_QUOTES, 'UTF-8'); ?>">
  <header class="app-header">
    <div class="header-bar">
      ...
      <a class="brand-link" href="<?php echo htmlspecialchars($indexPath, ENT_QUOTES, 'UTF-8'); ?>" title="Dashboard">
    ...
    <nav class="sidebar-nav">
      <div class="sidebar-section">
        ...
        <div class="sidebar-links">
          <?php if ($can('dashboard.view')): ?><a href="<?php echo htmlspecialchars($indexPath, ENT_QUOTES, 'UTF-8'); ?>">Dashboard</a><?php endif; ?>
          ...
          <?php if ($can('settings.view')): ?><a href="<?php echo htmlspecialchars($indexPath . '?view=settings', ENT_QUOTES, 'UTF-8'); ?>">Configuraciones</a><?php endif; ?>
        </div>
      </div>
      <div class="sidebar-section">
        <button class="sidebar-section-toggle" type="button">
        ...
        <div class="sidebar-links">
          ...
          <?php if ($can('reports.view')): ?><a href="<?php echo htmlspecialchars($indexPath . '?view=reports', ENT_QUOTES, 'UTF-8'); ?>">Reportes</a><?php endif; ?>
        </div>
      </div>
    </nav>
  </aside>
